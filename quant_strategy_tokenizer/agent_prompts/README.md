...
- `11_agent_project_usage_guide.md`: Step-by-step guide for teaching another agent how to use this modular project, with examples.
...
- To onboard another agent to this module package, use `11_agent_project_usage_guide.md`.
