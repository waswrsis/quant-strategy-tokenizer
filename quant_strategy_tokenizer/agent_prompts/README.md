...
- `11_agent_project_usage_guide.md`: Step-by-step guide for teaching another agent how to use QST modules, including the implemented trend and momentum indicator tokens and composition examples.
