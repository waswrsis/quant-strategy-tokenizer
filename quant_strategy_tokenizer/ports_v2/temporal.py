...
from quant_strategy_tokenizer.ports_v2.port_spec import (
    PortTemporalSpec,
    TemporalField,
    TemporalRule,
)
from quant_strategy_tokenizer.types_v2 import AvailableAt
...
def resolve_temporal_rule(
    ...
    *,
    ...
    """Resolve a WP3 TemporalRule into a PortTemporalSpec."""
...
def _max_available_at(values: list[AvailableAt]) -> AvailableAt:
    if any(value == "event_time" for value in values):
        raise TemporalRuleResolutionError("event_time cannot be ordered in WP3 max_inputs")
