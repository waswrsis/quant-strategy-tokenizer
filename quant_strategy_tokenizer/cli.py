...
from quant_strategy_tokenizer.decision import decision_algebra_token_pack_v2
...
from quant_strategy_tokenizer.panel import panel_ops_token_pack_v2, panel_weights_token_pack_v2
from quant_strategy_tokenizer.state import state_basic_token_pack_v2, state_fsm_token_pack_v2
...
def canonicalize(
    ...
    payload = canonical_bytes_v04(load_ir_v04_file(strategy))
    if output is None:
