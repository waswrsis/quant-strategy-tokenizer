"""
quant_strategy_tokenizer.indicators.analyst_upgrade_downgrade_ratio
=====================================================================
Purpose: measure analyst upgrade to downgrade ratio as an atomic sentiment token.
Core idea: Divide upgrades by downgrades. Assumes ratio form captures one-sided analyst consensus changes.
...
optional ExtractorSpec, AnalystUpgradeDowngradeRatioParams, and ModuleRunContext.
Outputs: AnalystUpgradeDowngradeRatioReport with quality, last values, sentiment direction/state,
...
INDICATOR = "analyst_upgrade_downgrade_ratio"


@dataclass
class AnalystUpgradeDowngradeRatioParams(SentimentParams):
    """Configuration for the analyst_upgrade_downgrade_ratio sentiment token.
...
@dataclass
class AnalystUpgradeDowngradeRatioRequest:
    data: Any
    params: AnalystUpgradeDowngradeRatioParams = field(default_factory=AnalystUpgradeDowngradeRatioParams)
    spec: DataFrameSpec = field(default_factory=DataFrameSpec)
    extractor: Optional[ExtractorSpec] = None
    context: ModuleRunContext = field(default_factory=lambda: ModuleRunContext(module=INDICATOR))


AnalystUpgradeDowngradeRatioReport = SentimentReport


def normalize_input(request: AnalystUpgradeDowngradeRatioRequest):
    return normalize_sentiment_input(request)


def run(request: AnalystUpgradeDowngradeRatioRequest) -> ModuleResult[AnalystUpgradeDowngradeRatioReport]:
    return run_sentiment_indicator(INDICATOR, request, module_name=INDICATOR)


__all__ = ["AnalystUpgradeDowngradeRatioParams", "AnalystUpgradeDowngradeRatioRequest", "AnalystUpgradeDowngradeRatioReport", "normalize_input", "run"]
