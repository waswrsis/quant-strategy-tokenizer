...
Core idea: users can compose EMA, ATR, VWAP, CHOP, spike, rolling-return, and
trend tokens in any order because each module accepts raw input and returns
detailed output.
...
insufficient history, invalid parameters, or unavailable optional backends.
