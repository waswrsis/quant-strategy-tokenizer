"""
quant_strategy_tokenizer.indicators.percent_positive_return
============================================================
Purpose: measure the percentage of instruments with positive returns as an atomic breadth token.
Core idea: Count positive-return constituents over the valid sample. Assumes broad positive participation confirms market direction.
...
PercentPositiveReturnParams, and ModuleRunContext.
Outputs: PercentPositiveReturnReport with quality, last values, breadth direction/state,
...
INDICATOR = 'percent_positive_return'


@dataclass
class PercentPositiveReturnParams(BreadthParams):
    """Configuration for the percent_positive_return breadth token.
...
@dataclass
class PercentPositiveReturnRequest:
    data: Any
    params: PercentPositiveReturnParams = field(default_factory=PercentPositiveReturnParams)
    spec: DataFrameSpec = field(default_factory=DataFrameSpec)
    extractor: Optional[ExtractorSpec] = None
    context: ModuleRunContext = field(default_factory=lambda: ModuleRunContext(module=INDICATOR))


PercentPositiveReturnReport = BreadthReport


def normalize_input(request: PercentPositiveReturnRequest):
    return normalize_breadth_input(request)


def run(request: PercentPositiveReturnRequest) -> ModuleResult[PercentPositiveReturnReport]:
    return run_breadth_indicator(INDICATOR, request, module_name=INDICATOR)


__all__ = ["PercentPositiveReturnParams", "PercentPositiveReturnRequest", "PercentPositiveReturnReport", "normalize_input", "run"]
