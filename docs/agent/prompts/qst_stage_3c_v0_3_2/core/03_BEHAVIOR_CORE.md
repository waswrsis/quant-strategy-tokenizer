...
Set the repository collaboration style for implementation, review, and repair work. This prompt is loaded before task-specific instructions and sets boundaries that
