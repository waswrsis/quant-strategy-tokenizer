...
Use this reader when the task depends on current repository evidence about active agent docs, prompt pack, validator, and prompt tests.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define active agent docs, prompt pack, validator, and prompt tests.
