...
Use this reader when the task depends on current repository evidence about CLI commands, accepted file suffixes, and refusal behavior.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define CLI commands, accepted file suffixes, and refusal behavior.
