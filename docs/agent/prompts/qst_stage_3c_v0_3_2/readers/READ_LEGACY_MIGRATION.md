...
Use this reader when the task depends on current repository evidence about historical migration wording that is not active capability.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define historical migration wording that is not active capability.
