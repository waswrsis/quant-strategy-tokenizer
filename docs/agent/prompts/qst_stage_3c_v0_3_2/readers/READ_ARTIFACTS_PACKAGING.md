...
Use this reader when the task depends on current repository evidence about reference artifacts, package boundaries, traces, fixtures, and hashes.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define reference artifacts, package boundaries, traces, fixtures, and hashes.
