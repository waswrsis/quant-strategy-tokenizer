...
Use this reader when the task depends on current repository evidence about repository directories and ownership boundaries.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define repository directories and ownership boundaries.
