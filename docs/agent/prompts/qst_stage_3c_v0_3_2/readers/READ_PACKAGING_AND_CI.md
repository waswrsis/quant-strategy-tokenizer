...
Use this reader when the task depends on current repository evidence about packaging metadata, entry points, and CI gates.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define packaging metadata, entry points, and CI gates.
