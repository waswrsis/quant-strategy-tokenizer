...
Use this reader when the task depends on current repository evidence about panel, selection, and weight reference semantics.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define panel, selection, and weight reference semantics.
