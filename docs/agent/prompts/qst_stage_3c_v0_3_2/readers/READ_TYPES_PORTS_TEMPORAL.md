...
Use this reader when the task depends on current repository evidence about types, ports, temporal rules, and validation behavior.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define types, ports, temporal rules, and validation behavior.
