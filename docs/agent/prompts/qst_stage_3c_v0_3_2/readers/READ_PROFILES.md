...
Use this reader when the task depends on current repository evidence about profile gate behavior and maturity matrix.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define profile gate behavior and maturity matrix.
