...
Use this reader when the task depends on current repository evidence about adapter, broker, exchange, and execution boundary claims.
The reader gathers facts; it does not decide or edit by itself.

## Read

- Active code, docs, tests, schemas, examples, or CI files that define adapter, broker, exchange, and execution boundary claims.
