...
- **Token Surface Patch**: useful for selected convenience gaps. `indicator.macd` was later retired by PR6; `weight.inverse_vol` remains a P1 convenience candidate rather than an acceptance blocker.
